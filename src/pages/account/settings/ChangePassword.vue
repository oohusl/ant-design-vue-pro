<template>
  <div class="main user-layout-register">
      ...
      <a-form ref="formRegister" :form="form" id="formRegister">
        <a-form-item>
          <a-input-password
            ...
            v-decorator="[
              'currentPassword',
              { rules: [{ required: true, message: '至少6位密码，区分大小写' }], validateTrigger: ['change', 'blur'] }
            ]"
          ></a-input-password>
        </a-form-item>
        <a-popover
    ...
    <div class="main user-layout-register" v-if="success">
      <a-result status="success" title="密码修改成功!" sub-title="">
        <template #extra>
...
<script>
import { getSmsCaptcha, changePassword } from '@/api/login'
